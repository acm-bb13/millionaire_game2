...
<body style="overflow:hidden">
    ...
    <%--人物--%>
    <img id="hero" onclick="onclickHero()" src="./resource/Game_hero/stay/image2267.png" style="position:absolute;transform:rotateY(180deg); top:100px; left:450px; z-index:5" width="90" height="190">


    <%--信息窗口--%>
    <div id="Message" class="Message_content" style="position: absolute;top:300px ; left: 300px ; z-index: 4;background:rgba(255,255,255,0.4) ; height: 250px;width: 400px" >
        <span id="yh">点击上方小人选择人物</span>
        ...
        <div class="left"> <button style="border-radius: 10px; border-color: #584b00; width: 110px;height: 25px" onclick="onclickChoose(1)">上一个人物存档</button>
            <button style="border-radius: 10px; border-color: #584b00; width: 110px;height: 25px" onclick="onclickChoose(1)">删除人物</button>
            <button style="border-radius: 10px; border-color: #584b00; width: 110px;height: 25px" onclick="onclickChoose(1)">下一个人物存档</button>
        </div>
    </div>

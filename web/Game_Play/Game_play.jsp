...
<head>
    ...
    <%--加载本界面控制js--%>
    <script src="./js/Game_Drive_begain.js"></script>
    ...
    <%--加载格子动画驱动--%>
    <script src="./js/Game_Drive_Paint_Grids.js"></script>
...
<body style="overflow:hidden;background: #000000;">
...
<%--格子贴图--%>
    ...
    <c:forEach begin="1" end="19" var="i">
        <img src="./resource/Game_resource/Grid/Grid_Fork_Big.png"
...
<%--特效贴图--%>
<img id="light_1" src="./resource/light/1/1.jpg" style="display: none;position:absolute; top:0px; left:0px; z-index:300 " width="150 " height="150">

    <c:forEach begin="1" end="20" var="i">
        <%--金币贴图--%>
        <img id="Gold${i}" class="Gold" src="./resource/Ps_Important/gold.png" style="position:absolute; top:${270}px; left:${150+i*10}px; z-index:300 " width="30 " height="30">
    </c:forEach>
    <c:forEach begin="1" end="20" var="i">
        <%--金币贴图--%>
        <img id="Gold${i+20}" class="Gold" src="./resource/Ps_Important/gold.png" style="position:absolute; top:${270+30}px; left:${150+i*10}px; z-index:300 " width="30 " height="30">
    </c:forEach>
    <c:forEach begin="1" end="20" var="i">
        <%--金币贴图--%>
        <img id="Gold${i+40}" class="Gold" src="./resource/Ps_Important/gold.png" style="position:absolute; top:${270+60}px; left:${150+i*10}px; z-index:300 " width="30 " height="30">
    </c:forEach>
    <c:forEach begin="1" end="20" var="i">
        <%--金币贴图--%>
        <img id="Gold${i+60}" class="Gold" src="./resource/Ps_Important/gold.png" style="position:absolute; top:${270+90}px; left:${150+i*10}px; z-index:300 " width="30 " height="30">
    </c:forEach>
    <c:forEach begin="1" end="20" var="i">
        <%--金币贴图--%>
        <img id="Gold${i+80}" class="Gold" src="./resource/Ps_Important/gold.png" style="position:absolute; top:${270+120}px; left:${150+i*10}px; z-index:300 " width="30 " height="30">
    </c:forEach>
    <c:forEach begin="1" end="10" var="i">
        <%--生命贴图--%>
        <img id="Health${i}" class="Health" src="./resource/Ps_Important/health.png" style="position:absolute; top:${270+120}px; left:${850-i*30}px; z-index:300 " width="30 " height="30">
    </c:forEach>

<%--骰子贴图--%>
<img id="number" src="./resource/Game_resource/number/image1033.png" style="position:absolute; top:270px; left:750px;filter: drop-shadow(20px 20px 0 #ccc); z-index:20" width="62.5" height="77.5">
